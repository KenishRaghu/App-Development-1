...
import com.example.mypr.Fragments.ChatsFragment;
import com.example.mypr.Fragments.ProfilFragment;
import com.example.mypr.Fragments.UserFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                {
                    Glide.with(getApplicationContext()).load(user1.getImageURL()).into(user);
                }
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId())
        {
            case R.id.logout:
                ...
                startActivity(new Intent(FarmerMain.this,MainActivity.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP));
                return true;
        }
        return false;
    }
